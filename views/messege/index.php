...
$this->registerJsFile('/basic/web/js/messege.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
...
// echo"</pre>";
    ...
    <button type="button" data-toggle="collapse" data-target="#questions-messege" class="feedback-add collapsed btn">
        <span class="pseudo-link">Сообщения пользователей</span>
    </button>
    <div id="questions-messege" class="collapse" aria-expanded="false" style="height: 0px;">
        <?= GridView_Messege::widget([
